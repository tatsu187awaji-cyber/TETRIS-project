import { COLUMNS, INITIAL_DROP_INTERVAL, LOCK_DELAY, createPiece, getPieceType } from '../core/constants.js';
...
/* 新規追加：マウスの現在列に向かって、衝突しない範囲で安全にミノを引き寄せる */
export function playerMoveToMouse(arena, gameState, resetLockDelay, autoRotate = false) {
    let targetX = gameState.mouseCol - (player.matrix[0].length / 2 | 0);
